		...
		if (window.XMLHttpRequest)
			...
			xmlhttp.onreadystatechange=function()
		 {
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			...
			window.location="view-pooja.php";
			}
		  }
		xmlhttp.open("GET","functions/poojaFunction.php?del="+del,true);
		xmlhttp.send();
	}
}
</script>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" class="bg-main"><table width="941" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top"><h2>View Location</h2></td>
      </tr>
      <tr>
        ...
        <td height="300" align="center" valign="top"><table width="700" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                <td width="411" align="left" valign="top" class="table-h">Location </td>
			  ...
			  if($count>0){
			   ...
			   ?>
              <tr>
                <td align="left" valign="top" class="table-t"><?php echo $data['l_city']; ?> </td>
                <td align="left" valign="top" class="table-t"><a href="edit-location.php?l_id=<?php echo $data['l_id'] ?>"><img src="images/edit.png" alt="edit" width="20" height="20" border="0" /></a></td>
                <td align="left" valign="top" class="table-t"><a href="javascript:deletet(<?php echo $data['l_id'] ?>);"><img src="images/delete.png" alt="delete" width="20" height="20" border="0" /></a></td>
              </tr>
              <?php }
			  }else
			  {
			  ?>
			  <tr><td colspan="3" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;">There is no data to display</td></tr>
			  <?php
			  }
			  ?>
            </table></td>
