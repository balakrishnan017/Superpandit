<?php 
	...
	if(isset($_POST['l_id']))
	{
		...
		if($city != "")
		{
			$sql="select * from tbl_location where l_city like '$city' and l_id != $l_id";
			$res=mysql_query($sql);
			...
			{
				$sql="update tbl_location set l_city='$city' where l_id=$l_id";
				$res=mysql_query($sql);
				if($res){
	...
	if(isset($_GET['l_id'])){
		extract($_GET);
		$sql="select * from tbl_location where l_id=$l_id";
		$res=mysql_query($sql);
          ...
          <tr>
			...
			<form method="post"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td height="35" align="left" valign="middle"><input name="city" id="city" type="text" class="T-F" onkeypress="return alphabetsOnly(event);" value="<?php echo $data['l_city']; ?>" /><input type="hidden" id="l_id" name="l_id" value="<?php echo $data['l_id'];?>" /></td>
              </tr>
			  <tr>
              ...
              <tr>
                ...
                <td width="52%" height="35" align="left" valign="middle"><label>
                  <input name="edit" type="submit" class="T-F-S" id="edit" value="Save" onclick="return validate();"/>
                </label></td>
              </tr>
            </table>
            </form></td>
