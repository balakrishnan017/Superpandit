...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" class="bg-main"><table width="941" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top"><h2>View Pooja</h2></td>
      </tr>
      <tr>
          ...
          <tr>
            <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td width="177" align="left" valign="top" class="table-h">Pooja Name </td>
                <td width="171" align="left" valign="top" class="table-h">Image </td>
              ...
              <tr>
                ...
                <td align="left" valign="top" class="table-t"><a href="edit-pooja.php?p_id=<?php echo $data['p_id'] ?>"><img src="images/edit.png" alt="edit" width="20" height="20" border="0" /></a></td>
