<?php 
	...
	$sql="select p_id,p_name,p_image from tbl_pandit";
	$res=mysql_query($sql);
		...
		if (window.XMLHttpRequest)
			...
			xmlhttp.onreadystatechange=function()
		 {
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			...
			window.location="view-pandit.php";
			}
		  }
		xmlhttp.open("GET","functions/panditFunction.php?del="+del,true);
		xmlhttp.send();
	}
}
</script>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" class="bg-main"><table width="941" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top"><h2>View Pandit</h2></td>
      </tr>
      <tr>
          ...
          <tr>
            <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td width="177" align="left" valign="top" class="table-h">Pandit Name </td>
                <td width="171" align="left" valign="top" class="table-h">services</td>
                <td width="126" align="left" valign="top" class="table-h">Edit</td>
              ...
              <tr>
                ...
                <td align="left" valign="top" class="table-t"><?php echo $data['p_name']; ?></td>
                <td align="left" valign="top" class="table-t"><img src="<?php echo "../".$data['p_image']; ?>" width="87" height="72"/></td>
                <td align="left" valign="top" class="table-t"><a href="edit-pandit.php?p_id=<?php echo $data['p_id'] ?>"><img src="images/edit.png" alt="edit" width="20" height="20" border="0" /></a></td>
                <td align="left" valign="top" class="table-t"><a href="javascript:deletet(<?php echo $data['p_id'] ?>);"><img src="images/delete.png" alt="delete" width="20" height="20" border="0" /></a></td>
              </tr>
              <?php }
			  }else
			  {
