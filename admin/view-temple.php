		...
		if (window.XMLHttpRequest)
			...
			xmlhttp.onreadystatechange=function()
		 {
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			...
			window.location="view-temple.php";
			}
		  }
		xmlhttp.open("GET","functions/templeFunction.php?del="+del,true);
		xmlhttp.send();
	}
}
</script>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top" class="bg-main"><table width="941" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" valign="top"><h2>View temple</h2></td>
      </tr>
      <tr>
          ...
          <tr>
            <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td width="177" align="left" valign="top" class="table-h">Temple Name </td>
                <td width="171" align="left" valign="top" class="table-h">Location </td>
              ...
              <tr>
                ...
                <td align="left" valign="top" class="table-t"><?php echo $data['t_name']; ?></td>
                <td align="left" valign="top" class="table-t"><?php echo $data['city_name']; ?></td>
                <td align="left" valign="top" class="table-t"><a href="edit-temple.php?t_id=<?php echo $data['t_id'] ?>"><img src="images/edit.png" alt="edit" width="20" height="20" border="0" /></a></td>
                <td align="left" valign="top" class="table-t"><a href="javascript:deletet(<?php echo $data['t_id'] ?>);"><img src="images/delete.png" alt="delete" width="20" height="20" border="0" /></a></td>
              </tr>
			   <?php }
			  }else
			  {
